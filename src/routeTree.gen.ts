...
const EditDocIdRoute = EditDocIdRouteImport.update({
  id: '/edit/$docId',
  path: '/edit/$docId',
  getParentRoute: () => rootRouteImport,
} as any)
const DatasetDatasetIdRoute = DatasetDatasetIdRouteImport.update({
...
export interface RootRouteChildren {
  ...
  DatasetDatasetIdRoute: typeof DatasetDatasetIdRoute
  EditDocIdRoute: typeof EditDocIdRoute
}
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/edit/$docId': {
      ...
      path: '/edit/$docId'
      fullPath: '/edit/$docId'
      preLoaderRoute: typeof EditDocIdRouteImport
      parentRoute: typeof rootRouteImport
    }
    '/dataset/$datasetId': {
      id: '/dataset/$datasetId'
      path: '/dataset/$datasetId'
      fullPath: '/dataset/$datasetId'
...
const rootRouteChildren: RootRouteChildren = {
  ...
  DatasetDatasetIdRoute: DatasetDatasetIdRoute,
  EditDocIdRoute: EditDocIdRoute,
}
