    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-4 text-muted-foreground">
          That URL doesn't exist in this archive.
        </p>
        <div className="mt-8">
          <Link
            to="/"
...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Upload, convert, edit and template PDFs in your browser. Export to Word, text, CSV. OCR for scanned documents." },
      { property: "og:title", content: "Paperflow — PDF conversion, editing & templates" },
      { property: "og:description", content: "Upload, convert, edit and template PDFs. Export to Word, text, CSV." },
