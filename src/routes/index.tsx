  ...
  head: () => ({
    meta: [
      { title: "Paperflow — PDF conversion, editing & templates" },
      {
        name: "description",
        content:
          "Convert PDFs to Word, text, CSV. Edit, annotate, and reuse templates. OCR for scans. Built for the modern web.",
      },
    ],
  }),
  component: () => (
    ...
    <form onSubmit={handleSubmit} className="mt-10 mx-auto max-w-md w-full px-4 sm:px-0">
      <div className="flex flex-col gap-3 sm:flex-row items-stretch sm:items-center">
        ...
        <Button
          type="submit"
          size="lg"
          className="h-12 w-full px-6 text-base sm:w-auto shrink-0 font-semibold shadow-md focus-visible:ring-2 focus-visible:ring-offset-2"
        >
...
function Hero() {
  return (
    <section className="relative overflow-hidden">
      ...
      <div
        className="absolute inset-x-0 top-0 -z-0 h-[600px] bg-[radial-gradient(ellipse_at_top,_color-mix(in_oklab,var(--accent)_18%,transparent)_0%,_transparent_60%)]"
        aria-hidden
      />
      <div className="relative mx-auto max-w-7xl px-4 pt-16 pb-20 md:px-8 md:pt-24 md:pb-28">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-base leading-relaxed text-muted-foreground sm:text-lg md:text-xl md:leading-relaxed">
            The fast, private PDF workspace for professionals, researchers, and creators. Convert
            PDFs to Word, text, or structured CSV, edit contents in-browser, and turn files into
            reusable templates.
          </p>
          ...
          <div className="mt-6 flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6 text-sm">
            <a
              href="#features"
              className="text-muted-foreground hover:text-foreground font-semibold underline underline-offset-4 hover:decoration-accent transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 rounded-sm px-1"
            >
              Explore PDF Features
            </a>
            <span className="hidden sm:inline text-muted-foreground/30">|</span>
            <span className="font-mono text-xs text-muted-foreground">
              No credit card. Files stay private.
            </span>
          </div>
        </div>
        ...
        <div className="relative mx-auto mt-12 md:mt-16 max-w-5xl">
          <div
            className="absolute -inset-4 -z-10 rounded-3xl bg-[var(--gradient-hero)] opacity-20 blur-3xl"
            aria-hidden
          />
            ...
            <div className="grid grid-cols-1 gap-0 md:grid-cols-[1fr_320px]">
              ...
              <div className="space-y-3 p-6">
                ...
                {[
                  ...
                  <div
                    key={item.label}
                    className="flex items-center justify-between rounded-lg border border-border px-3 py-2.5 text-sm transition-colors hover:bg-secondary"
                  >
  ...
  const items = [
    {
      icon: FileType2,
      title: "PDF → Word",
      body: "Editable .docx files that keep paragraphs, headings, and structure intact.",
    },
    {
      icon: FileText,
      title: "PDF → Text",
      body: "Clean plain text extraction — perfect for analysis, search, or AI pipelines.",
    },
    {
      icon: Sheet,
      title: "PDF → CSV",
      body: "Pull tabular data out of invoices, statements, and reports automatically.",
    },
    {
      icon: Wand2,
      title: "Templates",
      body: "Turn any PDF into a reusable template with editable placeholders. Save and remix.",
    },
    {
      icon: ScanText,
      title: "OCR for scans",
      body: "Scanned documents? We run optical character recognition to recover the text.",
    },
    {
      icon: ShieldCheck,
      title: "Private by default",
      body: "Files are scoped to your account with row-level security. Only you can see them.",
    },
  ];
  return (
      ...
      <div className="mx-auto max-w-7xl px-4 md:px-8">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <h2 className="mt-3 font-display text-3xl font-bold sm:text-4xl md:text-5xl">
            Everything you wished Acrobat did.
          </h2>
          <p className="mt-4 text-base text-muted-foreground sm:text-lg">
            A focused toolkit, not a 90s file manager.
          </p>
        </div>
        <div className="mt-16 grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {items.map((it) => (
            <div
              key={it.title}
              className="group relative bg-card p-8 rounded-2xl border border-border shadow-sm transition-all hover:-translate-y-1 hover:shadow-md hover:border-accent/30"
            >
...
function HowItWorks() {
  const steps = [
    { n: "01", title: "Upload", body: "Drag a PDF in. We store it privately in your workspace." },
    {
      ...
      body: "Pick a format or open the editor to annotate, highlight, and rewrite.",
    },
    {
      n: "03",
      title: "Reuse",
      body: "Save it as a template. Generate new docs from the same skeleton anytime.",
    },
  ];
  return (
        ...
        <div className="grid gap-12 md:grid-cols-[1fr_2fr] md:gap-20">
          ...
          <div className="space-y-6">
            {steps.map((s) => (
              <div
                key={s.n}
                className="flex gap-6 rounded-xl border border-border bg-card p-6 transition-shadow hover:shadow-[var(--shadow-elegant)]"
              >
  ...
  return (
    <section className="px-4 pb-20 md:pb-28 md:px-8">
      <div className="relative mx-auto max-w-5xl overflow-hidden rounded-3xl bg-primary px-6 py-16 sm:px-12 sm:py-20 text-primary-foreground md:px-16 md:py-24">
        ...
        />
        <div
          className="absolute -bottom-20 -left-10 h-72 w-72 rounded-full bg-accent/20 blur-3xl"
          aria-hidden
        />
        <div className="relative">
          ...
          <p className="mt-4 max-w-xl text-base text-primary-foreground/80 sm:text-lg">
            Sign up free and convert your first document in under a minute.
          </p>
          <div className="mt-8">
            <Button
              asChild
              size="lg"
              variant="secondary"
              className="h-12 w-full px-6 text-base sm:w-auto focus-visible:ring-2 focus-visible:ring-offset-2"
            >
              <Link
                to="/auth"
                search={{ mode: "signup" } as never}
                className="focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 rounded-md font-semibold"
              >
